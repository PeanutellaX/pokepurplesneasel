...
; Route 13
	db 27, PIDGEY, MEOWTH, RATTATA, PIDGEY, PERSIAN, 0
	db 30, POLIWAG, POLIWHIRL, 0
	db 28, PIDGEY, PERSIAN, CLEFAIRY, PIDGEOTTO, 0
...
; Route 21
	db 28, SEAKING, GOLDEEN, SEAKING, TENTACRUEL, 0
	db 31, SHELLDER, CLOYSTER, 0
	db 27, MAGIKARP, GYARADOS, MAGIKARP, GYARADOS, MAGIKARP, GYARADOS, 0
	db 33, POLIWHIRL, GOLDEEN, 0
; Route 12
...
CueBallData:
; Route 16
	db 28, MACHOP, PRIMEAPE, MACHOKE, 0
...
; Route 17
	...
	db 33, MACHOKE, 0
	db 28, MANKEY, PRIMEAPE, MACHOKE, MACHOP, 0
	db 29, PRIMEAPE, MACHOKE, 0
; Route 21
	db 31, TENTACOOL, POLIWHIRL, TENTACRUEL, 0
...
; Fuchsia Gym
	db 31, DROWZEE, WIGGLYTUFF, KADABRA, HYPNO, 0
...
; Route 13
	db 29, PIDGEY, PIDGEOTTO, 0
	db 25, FEAROW, PIDGEY, PIDGEOTTO, FARFETCHD, SPEAROW, 0
...
; Viridian Gym
	db $FF, 50, DUGTRIO, 53, PERSIAN, 53, NIDOQUEEN, 55, NIDOKING, 55, GOLEM, 0
...
; Silph Co. 5F
	...
	db 33, HYPNO, 0
; Silph Co. 6F
	db 29, GRAVELER, MACHOKE, 0
	db 28, ZUBAT, PARASECT, GOLBAT, 0
; Silph Co. 7F
	db 26, RATICATE, ARBOK, KOFFING, GOLBAT, 0
	db 29, GRIMER, MAROWAK, 0
	db 29, ZUBAT, SANDSLASH, 0
; Silph Co. 8F
...
; Jessie & James
	...
	db 33, WEEZING, ARBOK, MEOWTH, 0 ; Silph Co. 11F
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
BrockData:
	db $FF, 11, GEODUDE, 13, ONIX, 0

MistyData:
	db $FF, 18, POLIWAG, 20, HORSEA, 21, STARMIE, 0

LtSurgeData:
	db $FF, 23, VOLTORB, 25, RAICHU, 27, ELECTABUZZ, 0

ErikaData:
	db $FF, 30, TANGELA, 32, GLOOM, 33, EXEGGUTOR, 34, VICTREEBEL, 0

KogaData:
	db $FF, 44, BEEDRILL, 46, TENTACRUEL, 48, VENOMOTH, 50, NIDOQUEEN, 0

BlaineData:
	db $FF, 50, NINETALES, 52, FLAREON, 54, ARCANINE, 54, MAGMAR, 0

SabrinaData:
	db $FF, 50, HYPNO, 50, MR_MIME, 50, ALAKAZAM, 0
...
AgathaData:
	db $FF, 56, PARASECT, 56, GOLBAT, 55, MAROWAK, 58, ARBOK, 60, GENGAR, 0
